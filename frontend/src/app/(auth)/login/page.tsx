...
import { Wand2, Mail, Lock, Sparkles } from 'lucide-react';
          ...
          <div className="relative rounded-2xl p-8 bg-black/80 backdrop-blur-xl border border-gray-800/50 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4">
                <div className="relative">
                  <Label htmlFor="email" className="text-gray-200 ml-1 mb-1 block">
                    Email Address
                  </Label>
                  <div className="relative">
                ...
                <div className="relative">
                  <Label htmlFor="password" className="text-gray-200 ml-1 mb-1 block">
                    Password
                  </Label>
                  <div className="relative">
